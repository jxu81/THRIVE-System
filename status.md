...
| **SYS-R4** |     `??`    |    `??`   |    #4    |     #4    | TPLink-2053 (`192.168.0.104`)   | ![Setup](https://img.shields.io/badge/Status-In_Progress-lightgrey?style=for-the-badge) |
| **SYS-R5** |     #11    |    #8   |    #5    |     #5    | TPLink-1F6C (`192.168.0.105`) | ![Ready](https://img.shields.io/badge/Status-Ready-success?style=for-the-badge)         |
| **SYS-R6** |     #??    |    #??   |    #6    |     #6    | TPLink-2110 (`192.168.0.156`) | ![Ready](https://img.shields.io/badge/Status-Ready-success?style=for-the-badge)         |
